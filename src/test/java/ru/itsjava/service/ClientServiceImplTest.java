...
public class ClientServiceImplTest {
    public static final String DEFOULT_NAME = "Honor"; // создаем параметр DEFAULT_NAME
    ...
    public void checkBuyPhoneMethod() {
        Phone actualPhone = new Phone(DEFOULT_NAME, DEFAULT_PRICE); // создаем объект actualPhone с переменными (DEFAULT_NAME, DEFAULT_PRICE)
